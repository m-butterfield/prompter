...
export const Privacy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Prompter, 158 India St,
            Brooklyn NY 11222.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Prompter, accessible from{" "}
            <a
              href="https://getprompter.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://getprompter.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: help@getprompter.app</li>
      </ul>
    </div>
  );
};
